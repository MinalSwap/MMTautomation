...
public class FlightInfoPage extends TestBase{
	...
	// Pagefactory
	@FindBy(xpath="//body/div[@id='root']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/label[1]/div[1]/span[1]")
	WebElement nonStopFilter;
	
	@FindBy(xpath="//body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[5]/div[1]/div[1]/div[2]/div[1]/b[2]")
	WebElement departure612AmFilter;
	
	
	@FindBy(xpath="//body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/button[1]/span[1]")
	...
	public void nonStopFilterClick() {
		utilFunctions.ExpWaitForWebelement(nonStopFilter);
		if(utilFunctions.isVisble(nonStopFilter)) {
			nonStopFilter.click();
		}
	}
	
	public void Departure612AM() {
		utilFunctions.ExpWaitForWebelement(departure612AmFilter);
		if(utilFunctions.isVisble(departure612AmFilter)) {
			departure612AmFilter.click();
		}
	}
	
	public void ViewPricesBtnClick() {
		utilFunctions.ExpWaitForWebelement(viewPricesbutton);
		if(utilFunctions.isVisble(viewPricesbutton)) {
